...
export const errorStatusModel_message: string = "Forbidden - There aren't pending templates";
export const errorInvalidDateFormat_message: string = "Forbidden - Wrong data format";
...
export const InvalidDateFormat_message: string = "ERROR - Wrong date format";
...
export const modelNotFound_message: string = "Not Found - Model not found";
